...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    <div class="space-y-6 lg:col-span-2">
        <div class="admin-card space-y-5 p-6">
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <x-admin.form.input label="Type Name" name="name" :value="$type->name ?? null" required />
    ...
    <div class="space-y-6">
        ...
        <button type="submit" class="admin-btn-primary w-full">{{ isset($type) ? 'Update Type' : 'Create Type' }}</button>
    </div>
</div>
